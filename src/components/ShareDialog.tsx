      ...
      <div style={modalStyle} onClick={(e) => e.stopPropagation()}>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 20 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <h2 style={{ fontFamily: "var(--font-heading)", fontSize: "1.15rem", color: "var(--text)" }}>
              {t("title")}
            </h2>
          </div>
          <button
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
                  {internalLinks.map((le) => (
                    ...
                    >
                      ...
                      {!selectedLinkedIds.has(le.id) && (
                        <Lock style={{ width: 11, height: 11, color: "var(--text-dim)" }} />
                      )}
                    </label>
                  ))}
                </div>
        ...
        <div>
          ...
          {loading ? (
            <div style={{ display: "flex", justifyContent: "center", padding: 20 }}>
              <Loader2
                style={{ width: 18, height: 18, color: "var(--text-muted)", animation: "spin 1s linear infinite" }}
              />
            </div>
          ) : links.length === 0 ? (
                ...
                >
                  <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 8, flexWrap: "wrap" }}>
                    ...
                    <span style={{ fontSize: "0.7rem", color: "var(--text-dim)" }}>
                      ...
                      {link.maxViews !== null ? ` / ${link.maxViews} max` : ""}
                    </span>
                  </div>
                  ...
                  <div style={{ display: "flex", gap: 6 }}>
                    <button
                      ...
                      style={{
                        ...
                        background: "var(--surface)",
                        border: "1px solid var(--border)",
                        color: copiedId === link.id ? "var(--accent)" : "var(--text-secondary)",
                        fontSize: "0.75rem",
                        padding: "5px 10px",
                      }}
                    >
