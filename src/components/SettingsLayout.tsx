...
import { Settings, Users, Puzzle, Lock, FolderOpen, Webhook, Bot, Mail, UserCog, Bell, Paintbrush } from "lucide-react";
...
const userTabs = [
  { href: "/settings/appearance" as const, labelKey: "appearance", icon: Paintbrush },
