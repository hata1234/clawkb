    ...
    <div style={{ maxWidth: 720 }}>
      ...
      <div style={{ marginBottom: 24 }}>
        ...
        <p style={{ fontSize: "0.875rem", color: "var(--text-muted)", marginTop: 2 }}>
          Download your entries in various formats.
        </p>
      </div>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
        ...
        <div style={sectionStyle}>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: 16 }}>
            {[
              { label: "Content", checked: includeContent, set: setIncludeContent },
              { label: "Comments", checked: includeComments, set: setIncludeComments },
              { label: "Images", checked: includeImages, set: setIncludeImages },
          ...
          {loading ? (
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              <div style={{ fontSize: "1.5rem", fontWeight: 600, color: "var(--text)" }}>
                {stats.count} <span style={{ fontSize: "0.875rem", fontWeight: 400, color: "var(--text-muted)" }}>entries</span>
              </div>
        ...
        >
          ...
          {exporting ? "Exporting..." : `Export ${stats?.count || 0} entries as ${format.toUpperCase()}`}
        </button>
      </div>
