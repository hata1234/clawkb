        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 1 }}>
          {items.map((item) => {
            ...
            return (
              ...
              >
                <span style={{ fontSize: "1.1rem", flexShrink: 0, width: 28, textAlign: "center", lineHeight: "24px" }}>
                  {icon}
                </span>
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  {title && !item.entryId && (
                    <span
                      style={{ fontSize: "0.8rem", color: "var(--text-dim)", marginTop: 2, display: "inline-block" }}
                    >
                      {title}
                    </span>
                  )}
