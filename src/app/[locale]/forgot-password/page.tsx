    ...
    <div style={{
      ...
      <div style={{ width: "100%", maxWidth: 380, position: "relative", zIndex: 1 }}>
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", marginBottom: 40 }}>
          <Image src="/logo-clawkb-icon.png" alt="ClawKB" width={72} height={72} style={{ marginBottom: 20 }} priority />
          <h1 style={{ fontSize: "1.5rem", fontWeight: 700, marginBottom: 8, color: "var(--text)" }}>
            {t("title")}
          </h1>
