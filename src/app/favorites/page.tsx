  ...
  return (
    <div>
      <div style={{ marginBottom: 24 }}>
        ...
        <h1 style={{ fontFamily: "var(--font-heading)", fontSize: "1.75rem", fontWeight: 400, color: "var(--text)" }}>Favorites</h1>
        <p style={{ fontSize: "0.875rem", color: "var(--text-muted)", marginTop: 2 }}>{entries.length} starred</p>
      </div>
      ...
      {loading ? (
        ...
        <div style={{ textAlign: "center", padding: "60px 20px", color: "var(--text-muted)" }}>
          ...
          <p style={{ fontSize: "0.875rem" }}>No favorites yet. Star entries to see them here.</p>
        </div>
      ) : (
        <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
